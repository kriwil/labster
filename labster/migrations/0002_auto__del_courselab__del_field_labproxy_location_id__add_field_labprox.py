...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabProxy.location'
        db.add_column('labster_labproxy', 'location',
    ...
    def backwards(self, orm):
        ...
        db.create_table('labster_courselab', (
            ...
            ('location', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True)),
        ...
        # Deleting field 'LabProxy.location'
        db.delete_column('labster_labproxy', 'location')
