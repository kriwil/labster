...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabProxy.lab'
        db.alter_column('labster_labproxy', 'lab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Lab'], null=True))

    def backwards(self, orm):

        # Changing field 'LabProxy.lab'
        db.alter_column('labster_labproxy', 'lab_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['labster.Lab']))
