...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSave.play_count'
        db.add_column('labster_usersave', 'play_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserSave.is_finished'
        db.add_column('labster_usersave', 'is_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSave.play_count'
        db.delete_column('labster_usersave', 'play_count')

        # Deleting field 'UserSave.is_finished'
        db.delete_column('labster_usersave', 'is_finished')
