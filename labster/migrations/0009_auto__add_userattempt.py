...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAttempt'
        db.create_table('labster_userattempt', (
        ...
        db.send_create_signal('labster', ['UserAttempt'])


    def backwards(self, orm):
        # Deleting model 'UserAttempt'
        db.delete_table('labster_userattempt')
