...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserDeviceInfo'
        db.create_table('labster_userdeviceinfo', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
        ...
        db.send_create_signal('labster', ['UserDeviceInfo'])

        # Adding model 'GameErrorInfo'
        db.create_table('labster_gameerrorinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('lab', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Lab'])),
            ...
            ('date_encountered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('labster', ['GameErrorInfo'])


    def backwards(self, orm):
        # Deleting model 'UserDeviceInfo'
        db.delete_table('labster_userdeviceinfo')

        # Deleting model 'GameErrorInfo'
        db.delete_table('labster_gameerrorinfo')
    ...
    models = {
        ...
        'labster.gameerrorinfo': {
            ...
            'date_encountered': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
