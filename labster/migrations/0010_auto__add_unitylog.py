...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnityLog'
        db.create_table('labster_unitylog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('lab_proxy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.LabProxy'], null=True, blank=True)),
            ('log_type', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
        ...
        db.send_create_signal('labster', ['UnityLog'])


    def backwards(self, orm):
        # Deleting model 'UnityLog'
        db.delete_table('labster_unitylog')
