...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserDeviceInfo.date'
        db.alter_column('labster_userdeviceinfo', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'GameErrorInfo.date_encountered'
        db.alter_column('labster_gameerrorinfo', 'date_encountered', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'UserDeviceInfo.date'
        db.alter_column('labster_userdeviceinfo', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'GameErrorInfo.date_encountered'
        db.alter_column('labster_gameerrorinfo', 'date_encountered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
