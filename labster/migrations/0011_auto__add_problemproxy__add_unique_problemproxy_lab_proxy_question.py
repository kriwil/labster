...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProblemProxy'
        db.create_table('labster_problemproxy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lab_proxy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.LabProxy'])),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
        ...
        db.send_create_signal('labster', ['ProblemProxy'])

        # Adding unique constraint on 'ProblemProxy', fields ['lab_proxy', 'question']
        db.create_unique('labster_problemproxy', ['lab_proxy_id', 'question'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProblemProxy', fields ['lab_proxy', 'question']
        db.delete_unique('labster_problemproxy', ['lab_proxy_id', 'question'])

        # Deleting model 'ProblemProxy'
        db.delete_table('labster_problemproxy')
