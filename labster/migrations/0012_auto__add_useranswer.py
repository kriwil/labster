...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labster_useranswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('problem_proxy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.ProblemProxy'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('attempt_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('completion_time', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('is_view_theory_clicked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('play_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('labster', ['UserAnswer'])


    def backwards(self, orm):
        # Deleting model 'UserAnswer'
        db.delete_table('labster_useranswer')
