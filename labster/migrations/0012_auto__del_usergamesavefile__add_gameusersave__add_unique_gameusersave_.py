...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UserGameSaveFile'
        db.delete_table('labster_usergamesavefile')

        # Adding model 'GameUserSave'
        db.create_table('labster_gameusersave', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lab', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Lab'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('game_save_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('labster', ['GameUserSave'])

        # Adding unique constraint on 'GameUserSave', fields ['lab', 'user']
        db.create_unique('labster_gameusersave', ['lab_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'GameUserSave', fields ['lab', 'user']
        db.delete_unique('labster_gameusersave', ['lab_id', 'user_id'])

        # Adding model 'UserGameSaveFile'
        db.create_table('labster_usergamesavefile', (
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('game_save_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('lab', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Lab'])),
        ...
        db.send_create_signal('labster', ['UserGameSaveFile'])

        # Deleting model 'GameUserSave'
        db.delete_table('labster_gameusersave')
