...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemProxy.created_at'
        db.add_column('labster_problemproxy', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemProxy.created_at'
        db.delete_column('labster_problemproxy', 'created_at')
