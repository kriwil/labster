...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.use_quiz_blocks'
        db.add_column('labster_lab', 'use_quiz_blocks',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.use_quiz_blocks'
        db.delete_column('labster_lab', 'use_quiz_blocks')
