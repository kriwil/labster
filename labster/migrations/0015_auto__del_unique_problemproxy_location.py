...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ProblemProxy', fields ['location']
        db.delete_unique('labster_problemproxy', ['location'])


    def backwards(self, orm):
        # Adding unique constraint on 'ProblemProxy', fields ['location']
        db.create_unique('labster_problemproxy', ['location'])
