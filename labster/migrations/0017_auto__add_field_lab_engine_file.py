...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.engine_file'
        db.add_column('labster_lab', 'engine_file',
                      self.gf('django.db.models.fields.CharField')(default='labster.unity3d', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.engine_file'
        db.delete_column('labster_lab', 'engine_file')
