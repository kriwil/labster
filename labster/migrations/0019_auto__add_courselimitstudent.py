...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseLimitStudent'
        db.create_table('labster_courselimitstudent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('max_student', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('labster', ['CourseLimitStudent'])


    def backwards(self, orm):
        # Deleting model 'CourseLimitStudent'
        db.delete_table('labster_courselimitstudent')
    ...
    models = {
        ...
        'labster.courselimitstudent': {
            'Meta': {'object_name': 'CourseLimitStudent'},
            'course_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_student': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'labster.deviceinfo': {
