...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuizBlock'
        db.create_table('labster_quizblock', (
        ...
        db.send_create_signal('labster', ['QuizBlock'])

        # Adding model 'Problem'
        db.create_table('labster_problem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quiz_block', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.QuizBlock'])),
            ('problem_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('content_markdown', self.gf('django.db.models.fields.TextField')()),
            ('content_xml', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('labster', ['Problem'])


    def backwards(self, orm):
        # Deleting model 'QuizBlock'
        db.delete_table('labster_quizblock')

        # Deleting model 'Problem'
        db.delete_table('labster_problem')
    ...
    models = {
        ...
        'labster.quizblock': {
            'Meta': {'ordering': "('order', '-created_at')", 'object_name': 'QuizBlock'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
