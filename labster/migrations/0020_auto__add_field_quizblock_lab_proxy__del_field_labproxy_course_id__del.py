...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LabProxy', fields ['course_id', 'chapter_id', 'section_id', 'lab', 'unit_id']
        db.delete_unique('labster_labproxy', ['course_id', 'chapter_id', 'section_id', 'lab_id', 'unit_id'])

        # Adding field 'QuizBlock.lab_proxy'
        db.add_column('labster_quizblock', 'lab_proxy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.LabProxy'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LabProxy.course_id'
        db.delete_column('labster_labproxy', 'course_id')

        # Deleting field 'LabProxy.chapter_id'
        db.delete_column('labster_labproxy', 'chapter_id')

        # Deleting field 'LabProxy.section_id'
        db.delete_column('labster_labproxy', 'section_id')

        # Adding unique constraint on 'LabProxy', fields ['unit_id', 'lab']
        db.create_unique('labster_labproxy', ['unit_id', 'lab_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LabProxy', fields ['unit_id', 'lab']
        db.delete_unique('labster_labproxy', ['unit_id', 'lab_id'])

        # Deleting field 'QuizBlock.lab_proxy'
        db.delete_column('labster_quizblock', 'lab_proxy_id')

        # Adding field 'LabProxy.course_id'
        db.add_column('labster_labproxy', 'course_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'LabProxy.chapter_id'
        db.add_column('labster_labproxy', 'chapter_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'LabProxy.section_id'
        db.add_column('labster_labproxy', 'section_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding unique constraint on 'LabProxy', fields ['course_id', 'chapter_id', 'section_id', 'lab', 'unit_id']
        db.create_unique('labster_labproxy', ['course_id', 'chapter_id', 'section_id', 'lab_id', 'unit_id'])
    ...
    models = {
        ...
        'labster.labproxy': {
            'Meta': {'unique_together': "(('lab', 'unit_id'),)", 'object_name': 'LabProxy'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'labster.problem': {
            ...
            'content_xml': ('django.db.models.fields.TextField', [], {}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
