...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'QuizBlock', fields ['slug']
        db.delete_unique('labster_quizblock', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'QuizBlock', fields ['slug']
        db.create_unique('labster_quizblock', ['slug'])
