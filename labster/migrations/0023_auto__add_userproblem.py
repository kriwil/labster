...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserProblem'
        db.create_table('labster_userproblem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Problem'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('answer', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('labster', ['UserProblem'])


    def backwards(self, orm):
        # Deleting model 'UserProblem'
        db.delete_table('labster_userproblem')
