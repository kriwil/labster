...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProblem.is_correct'
        db.add_column('labster_userproblem', 'is_correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProblem.is_correct'
        db.delete_column('labster_userproblem', 'is_correct')
