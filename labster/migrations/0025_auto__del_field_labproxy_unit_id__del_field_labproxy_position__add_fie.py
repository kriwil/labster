...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LabProxy.unit_id'
        db.delete_column('labster_labproxy', 'unit_id')

        # Deleting field 'LabProxy.position'
        db.delete_column('labster_labproxy', 'position')

        # Adding field 'LabProxy.location_id'
        db.add_column('labster_labproxy', 'location_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding unique constraint on 'LabProxy', fields ['location_id', 'lab']
        db.create_unique('labster_labproxy', ['location_id', 'lab_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LabProxy', fields ['location_id', 'lab']
        db.delete_unique('labster_labproxy', ['location_id', 'lab_id'])

        # Adding field 'LabProxy.unit_id'
        db.add_column('labster_labproxy', 'unit_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'LabProxy.position'
        db.add_column('labster_labproxy', 'position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'LabProxy.location_id'
        db.delete_column('labster_labproxy', 'location_id')
