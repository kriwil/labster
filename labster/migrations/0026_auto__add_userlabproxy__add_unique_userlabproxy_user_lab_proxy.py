...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserLabProxy'
        db.create_table('labster_userlabproxy', (
        ...
        db.send_create_signal('labster', ['UserLabProxy'])

        # Adding unique constraint on 'UserLabProxy', fields ['user', 'lab_proxy']
        db.create_unique('labster_userlabproxy', ['user_id', 'lab_proxy_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserLabProxy', fields ['user', 'lab_proxy']
        db.delete_unique('labster_userlabproxy', ['user_id', 'lab_proxy_id'])

        # Deleting model 'UserLabProxy'
        db.delete_table('labster_userlabproxy')
