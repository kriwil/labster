...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabProxy.is_active'
        db.add_column('labster_labproxy', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'LabProxy.location_id'
        db.alter_column('labster_labproxy', 'location_id', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'LabProxy.is_active'
        db.delete_column('labster_labproxy', 'is_active')


        # Changing field 'LabProxy.location_id'
        db.alter_column('labster_labproxy', 'location_id', self.gf('django.db.models.fields.CharField')(max_length=100))
